				...
				<div class="card">
					<div class="header">
						<h2 style="font-weight: bold;color: #ad1455;font-size: 22px;">
							<center>FORM CLOSING PENGADUAN</center>
							<br>
						</h2>
					</div>
					...
					<div class="body">
						...
						<?php echo form_open('pengaduan/closing/' . $pengaduan['id_pengaduan'], $attribute); ?>

						<div class="row clearfix">
							<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
								<h4 style="font-size: 17.1px;">Penerima Pengembalian</h4>
							</div>
