				...
				<div class="card">
					<div class="header">
						<h2 style="font-weight: bold;color: #ad1455;font-size: 22px;">
							<center>FORM LAPOR PENGADUAN</center>
							<br>
						</h2>
					</div>
					...
					<div class="body">
						...
						<?php echo form_open_multipart('pengaduan/tindakan/' . $pengaduan['id_pengaduan'], $attribute); ?>

						<div class="row clearfix">
							<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
								<h4 style="font-size: 17.1px;">Tindakan</h4>
							</div>
							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
								<div class="form-group">
									<div class="form-line">
										<textarea name="tindakan" id="" class="form-control"><?= isset($pengaduan['tindakan']) ? $pengaduan['tindakan'] : '' ?></textarea>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row clearfix">
							<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
								<h4 style="font-size: 17.1px;">Lampiran</h4>
							</div>
							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
								<div class="form-group">
									<div class="form-line">
