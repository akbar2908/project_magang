			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<div class="body">
						...
						<?php echo form_open('item/edit/' . $item['id_item'], $attribute); ?>



						<div class="row clearfix">
							<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
								<h4 style="font-size: 17.1px;">Nama Item</h4>
							</div>
							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
								<div class="form-group">
									<div class="form-line">
										<input type="text" value="<?= $item['nama_item'] ?>" class="form-control" placeholder="Ex : 80" name="nama_item" required autocomplete="off" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row clearfix">
							<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
								<h4 style="font-size: 17.1px;">Jenis Item</h4>
							</div>
							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
								<div class="form-group">
									<div class="form-line">
										<input type="text" value="<?= $item['jenis_item'] ?>" class="form-control" placeholder="Ex : 80" name="jenis_item" required autocomplete="off" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row clearfix">
							<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
								<h4 style="font-size: 17.1px;">Harga Item</h4>
							</div>
							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
								<div class="form-group">
									<div class="form-line">
										<input type="text" value="<?= $item['harga_item'] ?>" class="form-control" placeholder="Ex : 80" name="harga_item" required autocomplete="off" />
									</div>
								</div>
							</div>
						</div>
