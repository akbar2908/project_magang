...
<body class="login-page" style=" background: linear-gradient(to top, rgba(2,0,36,1) 0%, rgba(45,45,148,1) 35%, rgba(0,100,,1) 50%);">
	...
	<div class="login-box maxmax">
		...
		<div class="logo">
			<img src="<?= base_url(); ?>assets/login/img/logo_pusri.png" style="margin-bottom:20px; width:120px; height:155px; position: relative;" class="responsive-image center-block">
			<a href="javascript:void(0);"><b style="font-size: 15px">PENGADUAN PERBAIKAN PERANGKAT KOMPUTER</b></a>
			<small style="font-size: 17px">PT PUSRI PALEMBANG</small>
		</div>
		...
		<div class="card" style="border-radius: 25px !important;">
			<div class="body">
				...
				<form class="form-signin" method="POST" action="<?php echo base_url() ?>auth/login">
					...
					<div class="msg" style="margin-top:20px; font-weight: bold; color: #FFC107;">Silahkan login terlebih dahulu</div>
					...
					<div class="row">
						...
						<div class="col-xs-4">
							...
							<input type="submit" name="login" value="Masuk" class="btn btn-block bg-amber waves-effect">
