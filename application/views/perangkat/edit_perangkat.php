				...
				<div class="card">
					<div class="header">
						<h2 style="font-weight: bold;color: #ad1455;font-size: 22px;">
							<center>Form Edit Perangkat</center>
							<br>
						</h2>
					</div>
					...
					<div class="body">
						...
						<?php echo form_open('perangkat/edit/' . $perangkat['id_perangkat'], $attribute); ?>
						...
						<div class="row clearfix">
							...
							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
								<div class="form-group">
									<div class="form-line">
										<input value="<?= $perangkat['no_inventaris'] ?>" type="text" class="form-control" placeholder="Ex : XXX/111/" name="no_inventaris" required autocomplete="off" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row clearfix">
							...
							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
								<div class="form-group">
									<div class="form-line">
										<input value="<?= $perangkat['nama_perangkat'] ?>" type="text" class="form-control" placeholder="Ex : Body" name="nama_perangkat" required autocomplete="off" />
									</div>
								</div>
							</div>
