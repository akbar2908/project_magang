                                        ...
                                        foreach ($users as $user) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($user['role'] == 'A') : ?>
                                                        Admin
                                                    <?php elseif ($user['role'] == 'T') : ?>
                                                        Teknisi
                                                    <?php elseif ($user['role'] == 'P') : ?>
                                                        Pengguna
                                                    <?php elseif ($user['role'] == 'K') : ?>
                                                        Kepala
                                                    <?php endif; ?>
                                                </td>
                                                ...
                                                <td style="text-align: center;vertical-align: middle;">
                                                    <center>
                                                        <a href="<?= base_url('User/edit/' . $user['id_user']) ?>" data-toggle="tooltip" data-placement="top" title="Edit"><i style="color:#00b0e4;" class="material-icons">description</i></a>&nbsp;
