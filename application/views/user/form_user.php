                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    <?php if ($page == 'add') : ?>
                                        <?php echo form_open('user/add', $attributes); ?>
                                    <?php else : ?>
                                        <?php echo form_open('user/edit/' . $user['id_user'], $attributes); ?>
                                    <?php endif; ?>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                            <h4 style="font-size: 17.1px;">Role</h4>
                                        </div>
                                        <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <select style="font-size: 14px;" class="form-control show-tick" name="role" required autocomplete="off">
                                                        <!-- <option value="" selected disabled>-- Pilih Role --</option> -->
                                                        <option value="K">Kepala</option>
